...
public class cake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        food.add(new FoodItem("BLACK FOREST","30/-"));
        food.add(new FoodItem("MANGO/PINEAPPLE","30/-"));
        food.add(new FoodItem("STRAWBERRY","30/-"));
        food.add(new FoodItem("CAKE PER POUND","250/-"));
